...
function trocarImagem(){
    ...
    imagemSelecionada = idOpcaoSelecionada.charAt(0); // pega o primeiro caracter do id selecionado, pra isso serve o charAt nao posiçao zero
...
function trocarTamanho(){
    ...
    if (tamanhoSelecionadoopcoes[tamanhoSelecionado] ==='41 mm'){
